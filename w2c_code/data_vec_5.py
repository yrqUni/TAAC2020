...
#data
#data_path = r'C:\Users\yrqun\Desktop\TMP\w2c_data\industry_merge_data.csv'

#word2vec
word2vec_dict_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\industry.txt'
word2vec_word2vec_model_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\industry.model'
word2vec_wordvectors_kv_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\industry.kv'
data_vec_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\industry.csv'
...
###
    ...
    data_industry = data.groupby("user_id")['industry'].apply(list).reset_index(name='industry')['industry']
    with open(word2vec_dict_filepath, 'w')as f:
        with tqdm(total=int(len(data_industry))) as pbar:
            for i in data_industry:
                i = [str(e) for e in i]
                line = ' '.join(i)
                f.write(line+'\n')
                pbar.update(1) 
