...
#data
#data_path = r'C:\Users\yrqun\Desktop\TMP\w2c_data\product_category_merge_data.csv'

#word2vec
word2vec_dict_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\product_category.txt'
word2vec_word2vec_model_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\product_category.model'
word2vec_wordvectors_kv_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\product_category.kv'
data_vec_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\product_category.csv'
...
###
    ...
    data_product_category = data.groupby("user_id")['product_category'].apply(list).reset_index(name='product_category')['product_category']
    with open(word2vec_dict_filepath, 'w')as f:
        with tqdm(total=int(len(data_product_category))) as pbar:
            for i in data_product_category:
                i = [str(e) for e in i]
                line = ' '.join(i)
                f.write(line+'\n')
                pbar.update(1) 
