...
#data
#data_path = r'C:\Users\yrqun\Desktop\TMP\w2c_data\time_merge_data.csv'

#word2vec
word2vec_dict_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\time.txt'
word2vec_word2vec_model_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\time.model'
word2vec_wordvectors_kv_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\time.kv'
data_vec_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\time.csv'
...
###
    ...
    data_time = data.groupby("user_id")['time'].apply(list).reset_index(name='time')['time']
    with open(word2vec_dict_filepath, 'w')as f:
        with tqdm(total=int(len(data_time))) as pbar:
            for i in data_time:
                i = [str(e) for e in i]
                line = ' '.join(i)
                f.write(line+'\n')
