...
#data
#data_path = r'C:\Users\yrqun\Desktop\TMP\w2c_data\ad_id_merge_data.csv'

#word2vec
word2vec_dict_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\ad_id.txt'
word2vec_word2vec_model_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\ad_id.model'
word2vec_wordvectors_kv_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\ad_id.kv'
data_vec_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\ad_id.csv'
...
###
    ...
    data_ad_id = data.groupby("user_id")['ad_id'].apply(list).reset_index(name='ad_id')['ad_id']
    with open(word2vec_dict_filepath, 'w')as f:
        with tqdm(total=int(len(data_ad_id))) as pbar:
            for i in data_ad_id:
                i = [str(e) for e in i]
                line = ' '.join(i)
                f.write(line+'\n')
