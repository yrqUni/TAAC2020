...
#data
#data_path = r'C:\Users\yrqun\Desktop\TMP\w2c_data\advertiser_id_merge_data.csv'

#word2vec
word2vec_dict_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\advertiser_id.txt'
word2vec_word2vec_model_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\advertiser_id.model'
word2vec_wordvectors_kv_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\advertiser_id.kv'
data_vec_filepath = r'C:\Users\yrqun\Desktop\TMP\w2c_data\150\advertiser_id.csv'
...
###
    ...
    data_advertiser_id = data.groupby("user_id")['advertiser_id'].apply(list).reset_index(name='advertiser_id')['advertiser_id']
    with open(word2vec_dict_filepath, 'w')as f:
        with tqdm(total=int(len(data_advertiser_id))) as pbar:
            for i in data_advertiser_id:
                i = [str(e) for e in i]
                line = ' '.join(i)
                f.write(line+'\n')
                pbar.update(1) 
